  ...
  return (
    <>
      <section>
        ...
        {/* contact */}
        <div className="bg-white py-[5rem] lg:py-[10rem] page-padding grid lg:grid-cols-2 container gap-10 items-center grid-cols-1">
          {/* first col */}
          <div className="flex flex-col mx-auto w-full">
            <h2 className="text-black text-[24px] lg:text-[36px] font-bold leading-[1.2]">
              We are here for help you! To Shape Your Body.
            </h2>
            <p className="text-[14px] lg:text-[16px] w-[95%] text-[#646464] font-medium my-[2rem] lg:my-[40px]">
            ...
            <div className="grid lg:grid-cols-2 grid-rows-2 gap-y-10 lg:gap-y-20 grid-cols-1 min620:mx-auto">
              ...
              <div className="flex flex-col relative">
                ...
                <div className="text-[15px] font-medium text-[#646464]">
                  <p>Mon to Fri: 6:00 am — 11:00 pm</p>
                  <p>Sat to Sun: 6:00 am — 9:00 pm</p>
                </div>
              </div>
              {/*  */}
              <div className="flex flex-col relative">
          ...
          <form className="flex flex-col pt-[30px] px-[3rem] lg:pr-[50px] mt-0 pb-[50px] lg:pl-[45px] bg-[#f8f8f8] relative mx-auto w-full">
            <h3 className="text-[28px] font-bold mb-14">Leave Us Your Info</h3>
            <span className="bg-[#ff0336] w-[50px] h-[4px] absolute top-[67px] lg:top-[77px]"></span>
            <input
              className="w-full py-[12px] px-[4%] lg:px-[20px] h-[51px] text-[14px] border border-solid border-[#e4e4e4] outline-none mb-8"
            ...
            <input
              ...
              type="email"
            ></input>
            <select className="w-full py-[12px] px-[4%] lg:px-[20px] h-[51px] text-[14px] border border-solid border-[#e4e4e4] outline-none mb-8">
            ...
            <textarea
              placeholder="Comment"
              className="w-full py-[12px] px-[4%] lg:px-[20px] h-[140px] text-[14px] border border-solid border-[#e4e4e4] outline-none mb-8"
            ></textarea>
            <button
              type="submit"
