  ...
  return (
    <>
      <div className="flex flex-wrap gap-3 lg:gap-4 justify-center">
        ...
        <Link to="/schedule/thursday" className="text-[12px] lg:text-[15px] font-bold border-solid border border-border py-[9px] px-[10px] lg:px-[32px] rounded-[23px] bg-primary ease-in duration-200 hover:shadow-2xl text-white">Thursday</Link>
