  ...
  return (
    <>
      <div className="flex flex-wrap gap-3 lg:gap-4 justify-center">
        ...
        <Link to="/schedule/wednesday" className="text-[12px] lg:text-[15px] font-bold border-solid border border-border py-[9px] px-[10px] lg:px-[32px] rounded-[23px] bg-primary ease-in duration-200 hover:shadow-2xl text-white">Wednesday</Link>
        ...
        <div className="flex flex-col gap-3">
          <ul className="flex justify-between w-full flex-col lg:flex-row text-center lg:text-left">
            ...
            <li className="class-info py-[3%] lg:py-[25px] bg-[#f2f2f2] w-full text-center">
              ...
              <p className="text-[18px] text-black font-bold mt-3">Li Xiao</p>
            </li>
